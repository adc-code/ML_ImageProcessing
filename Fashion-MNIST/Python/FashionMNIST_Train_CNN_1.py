...
# The purpose of this script is to train a model using a rather simple convolutional
...
IMG_WIDTH           = 28
IMG_HEIGHT          = 28
IMG_DEPTH           = 1     # one channel since we have gray scale images
VALIDATION_SET_SIZE = 5000

MODEL_OUTPUT_FILE   = 'FashionMNIST_Model_CNN_1.h5'
